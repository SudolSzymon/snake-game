...
public class Gameview extends JFrame implements KeyListener {
	...
	private class FieldView extends JPanel {
		private final int GRID_VIEW_SCALING_FACTOR = 12;
	...
	public Gameview(int height, int width) {
		...
		setTitle("Snake");
		score = new JLabel(SCORE_PREFIX, JLabel.CENTER);
		setLocation(100, 50);
		...
		contents.add(score, BorderLayout.SOUTH);
		pack();
		setVisible(true);
	}
	...
	public void showStatus(Field field) {
		...
		score.setText(SCORE_PREFIX + stats.getScore(field));
		fieldView.repaint();
	}
}
